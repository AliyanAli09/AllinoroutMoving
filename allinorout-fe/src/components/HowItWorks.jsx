  ...
  const steps = [
    {
      ...
      title: "Fill Out Form",
      description: "Tell us about your moving needs and schedule.",
      detail: "Enter pickup/drop-off addresses, date, time, and special items"
    },
    {
      number: "2", 
      ...
      detail: "Pay a small deposit to lock in your moving date and time"
    },
    {
      number: "3",
    ...
    },
    {
      ...
      title: "Mover Contacts You",
      description: "Professional mover reaches out to confirm details.",
      detail: "A vetted mover will contact you directly to finalize arrangements"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get your move started in four simple steps. We handle the mover matching - you just relax.
          </p>
        </div>
