  ...
  const handleStripeCheckout = async () => {
    ...
    try {
      ...
      const response = await paymentService.createCheckoutSession(
        ...
        `${window.location.origin}/mover/dashboard?success=true`,
                ...
                <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
                 ...
                 <div className="bg-gray-50 p-4 rounded-lg">
                   <div className="flex items-center justify-between mb-2">
                     ...
                     <span className="text-lg font-bold text-gray-900">$150.00</span>
                   </div>
                 ...
                 >
                   {loading ? (
                     ...
                     <>
                       ...
                       <span>Subscribe with Stripe - $150/month</span>
                     </>
                   )}
                 </button>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">$150/month</span>
                </div>
