...
const AdminBookings = () => {
  ...
  const handleUpdateBooking = async () => {
    ...
    if (isAssigningMover) {
      ...
      setConfirmAction({
        type: 'assign_mover',
        message: `Are you sure you want to assign ${selectedMover?.businessName} to this booking? This will send email notifications to both the customer and mover.`,
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search bookings by customer or mover..."
                  value={searchTerm}
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <option value="pending-assignment">Looking for movers</option>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="text-sm text-gray-500">
                            {booking.mover?.email || 'No mover assigned'}
                          </div>
                        </div>
                      </div>
                    </td>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                      {selectedBooking.moveType === 'long-distance' 
                        ...
                        : 'This booking is waiting for a mover to provide a quote'
                      }
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    <option value="">Select a mover (optional)</option>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Only verified and approved movers are shown
                  </p>
                </div>
