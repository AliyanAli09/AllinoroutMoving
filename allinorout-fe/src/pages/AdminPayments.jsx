...
import { FiDollarSign, FiFilter, FiSearch, FiEye, FiCalendar, FiUser, FiTruck, FiMapPin } from 'react-icons/fi';
...
const AdminPayments = () => {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      ...
      case 'mover-subscription': return <FiTruck className="h-4 w-4" />;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="mover-subscription">Mover Subscription</option>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 text-sm text-gray-900">
                          {payment.type === 'booking-deposit' ? 'Booking Deposit' :
                           payment.type === 'mover-subscription' ? 'Mover Subscription' :
