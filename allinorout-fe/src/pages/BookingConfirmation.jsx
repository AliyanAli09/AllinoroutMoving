...
import { FiCheckCircle, FiTruck, FiMail, FiPhone, FiCalendar, FiMapPin, FiClock, FiArrowRight, FiLoader, FiRefreshCw } from 'react-icons/fi';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-4">
            {bookingData.depositPaid 
              ? 'Thank you for your booking! Your payment has been processed successfully and professional movers in your area are being notified.'
              : bookingData.moveType === 'long-distance'
                ? 'Thank you for your long-distance move request! Our team will review your request and contact you within 24 hours with a personalized quote.'
                : 'Thank you for your booking request! Professional movers in your area are being notified and will contact you soon.'
            }
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div className="flex items-center justify-between text-white">
              <div>
                ...
                <p className="text-blue-100">ID: #{bookingData.bookingId}</p>
              </div>
            ...
            {bookingData.depositPaid ? (
              ...
              <>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Movers Are Notified</h4>
                    <p className="text-gray-600">Professional moving companies in your area are being contacted about your job.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Work directly with your chosen mover to confirm all details and schedule your move.</p>
                  </div>
                </div>
              </>
            ) : bookingData.moveType === 'long-distance' ? (
              ...
              <>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Our team is reviewing your long-distance move request and gathering specialized movers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Move Coordination</h4>
                    <p className="text-gray-600">Our team will coordinate with specialized long-distance movers to finalize your move details.</p>
                  </div>
                </div>
              </>
            ) : (
              ...
              <>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Please wait for your payment to be confirmed before the movers are notified.</p>
                  </div>
                </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Our support team is here to assist you with any questions about your move.
            </p>
            <div className="space-y-3">
              <a
                href="mailto:support@bookandmove.com"
              ...
              >
                ...
                <span>allinoroutmoving@gmail.com</span>
              </a>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Planning Your Move?</h3>
            <p className="text-gray-600 mb-6">
              Get tips and resources to make your moving day smooth and stress-free.
            </p>
            <Link
              to="/"
              className="inline-flex items-center justify-center space-x-2 w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
            >
