...
import { FiUsers, FiTruck, FiCalendar, FiDollarSign, FiTrendingUp, FiSettings, FiShield, FiBarChart2, FiAlertCircle, FiUser } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Total Movers</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Mover Management</h3>
                <p className="text-sm text-gray-600 mt-1">
                  Manage mover accounts & verifications
                </p>
              </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {payment.type === 'booking-deposit' ? 'Booking Deposit' :
                           payment.type === 'mover-subscription' ? 'Mover Subscription' : payment.type}
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
