...
const AdminMovers = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading movers...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <AdminLayout 
      ...
      subtitle="Manage mover accounts & verifications"
    >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search movers by name or email..."
                  value={searchTerm}
      ...
      <AdminModal
        ...
        title={`Verify Mover - ${selectedMover?.firstName} ${selectedMover?.lastName}`}
        confirmText="Approve"
        cancelText="Reject"
              ...
              {selectedMover.verificationDocuments && selectedMover.verificationDocuments.length > 0 ? (
                ...
                <div className="text-center py-8 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    This mover needs to upload business documents for verification
                  </p>
                </div>
              )}
            </div>
      ...
      {showDeleteModal && (
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-gray-700">This action cannot be undone and will permanently remove the mover account and all associated data.</p>
            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
              ...
              >
                {deletingMover ? 'Deleting...' : 'Delete Mover'}
              </button>
            </div>
          </div>
        </AdminModal>
      ...
      {showMoverModal && selectedMover && (
        <AdminModal
          ...
          title={`Mover Details - ${selectedMover.firstName} ${selectedMover.lastName}`}
          showActions={false}
        >
          <div className="space-y-6">
            {/* Basic Information */}
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
              ...
              {/* Show approve/deny buttons only for pending movers */}
