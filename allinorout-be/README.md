# All In Or Out Moving - Backend API

Node.js backend API for the All In Or Out Moving platform serving Las Vegas, Nevada.

## 🏢 Business Information

- **Business Name:** All In Or Out Moving
- **Email:** allinjoroutmoving@gmail.com
...
2. **Environment Setup**
   ...
   MONGODB_URI=mongodb://localhost:27017/allinorout
   ...
   GMAIL_USER=allinoroutmoving@gmail.com
   GMAIL_PASS=your_gmail_app_password
   EMAIL_FROM=allinoroutmoving@gmail.com
