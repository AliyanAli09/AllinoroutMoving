...
const recreateAdmin = async () => {
  try {
    ...
    const deleteResult = await User.deleteOne({ email: 'mrzaneone@gmail.com' });
    ...
    const savedUser = await User.findOne({ email: 'mrzaneone@gmail.com' }).select('+password');
