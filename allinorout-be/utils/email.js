...
const createTransporter = () => {
  ...
  console.log('Attempting Gmail SMTP connection with:', {
    ...
    pass: '***' + process.env.GMAIL_PASS.slice(-3)
  });
...
export const emailTemplates = {
  ...
  welcome: (userData) => ({
    subject: 'Welcome to ALLinorout Moving!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <title>Welcome to ALLinorout Moving</title>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to ALLinorout Moving!</h1>
            <p>Your moving journey starts here</p>
          </div>
          <div class="content">
            <h2>Hi ${userData.firstName}!</h2>
            <p>Welcome to ALLinorout Moving! We're excited to have you on board.</p>

            <p>With ALLinorout Moving, you can:</p>
            <ul>
              <li>Find reliable movers in your area</li>
              <li>Get competitive quotes</li>
              <li>Book moves on your schedule</li>
            ...
            <p>Best regards,<br>The ALLinorout Moving Team</p>
          </div>
          <div class="footer">
            <p>© ${new Date().getFullYear()} ALLinorout Moving. All rights reserved.</p>
  ...
  // Welcome email for new movers
  welcomeMover: (moverData) => ({
    subject: 'Welcome to ALLinorout Moving - Start Growing Your Moving Business!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Welcome to ALLinorout Moving - Professional Mover</title>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to ALLinorout Moving!</h1>
            <p>Your gateway to more moving jobs and higher earnings</p>
          </div>
          <div class="content">
            <div class="welcome-badge">
Professional Mover Account Created
            </div>
            
            <h2>Hi ${moverData.firstName}!</h2>
            <p>Congratulations! You've successfully joined ALLinorout Moving, the premier platform connecting professional movers with customers who need reliable moving services.</p>
            ...
            <h3 style="color: #059669;">What ALLinorout Moving Offers You:</h3>
            ...
            <div class="contact-info">
              ...
              <p>Our support team is here to help you succeed on ALLinorout Moving!</p>
              <p><strong>Email:</strong> support@bookandmove.com</p>
              <p><strong>Pro Tip:</strong> Complete your profile fully to receive more job opportunities!</p>
            </div>
            
            <p style="margin-top: 30px;">We're excited to help you grow your moving business and connect you with customers who need your professional services.</p>
            
            <p><strong>Welcome to the ALLinorout Moving family!</strong></p>
            
            <p>Best regards,<br><strong>The ALLinorout Moving Team</strong></p>
          </div>
          <div class="footer">
            <p><strong>support@allinoroutmoving.com</strong></p>
            <p>© ${new Date().getFullYear()} ALLinorout Moving. All rights reserved.</p>
  ...
  passwordReset: (data) => ({
    subject: 'Reset Your ALLinorout Moving Password',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Secure your ALLinorout Moving account</p>
          </div>
          <div class="content">
            <h2>Hi ${data.firstName}!</h2>
            <p>We received a request to reset your password for your ALLinorout Moving account.</p>
  ...
  passwordResetConfirmation: (userData) => ({
    subject: 'Your ALLinorout Moving Password Has Been Reset',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hi ${userData.firstName}!</h2>
            <p>Your ALLinorout Moving password has been successfully reset.</p>
  ...
  bookingConfirmation: (bookingData) => ({
    subject: 'Booking Confirmed - Your Move is Scheduled!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Great news! Your moving booking has been confirmed. We're connecting you with qualified movers in your area.</p>
            ...
            <div class="booking-details">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">${bookingData.moveTime}</span>
              </div>
              <div class="detail-row">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">${bookingData.moveType.charAt(0).toUpperCase() + bookingData.moveType.slice(1)}</span>
              </div>
              <div class="detail-row">
            ...
            <div class="contact-info">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                <li>Qualified movers will review your request</li>
                <li>You'll receive quotes within 24 hours</li>
                <li>Compare quotes and choose your mover</li>
                <li>Confirm details directly with your chosen mover</li>
              </ul>
            </div>
            
            <p>Track your booking status and manage your move:</p>
          ...
          <div class="content">
            ...
            <div class="security-note">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                ...
                <li>Movers are being notified about your job</li>
                <li>You'll receive quotes within 24 hours</li>
    ...
    html: `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>New Job Alert!</h1>
            <p>A customer needs your moving services</p>
          </div>
          <div class="content">
            <h2>Hi ${jobData.moverName}!</h2>
            <p>A new moving job matching your service area is available. Act fast to secure this opportunity!</p>
            ...
            <div class="job-details">
              ...
              <div class="detail-row">
                <span class="detail-label">Move Date:</span>
                <span class="detail-value">${new Date(jobData.moveDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">Time:</span>
                <span class="detail-value">${jobData.moveTime}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">Home Size:</span>
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">${jobData.moveType.charAt(0).toUpperCase() + jobData.moveType.slice(1)} Move</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">From:</span>
            ...
            <p><strong>Time Sensitive:</strong> Other movers in your area have also been notified. Respond quickly to secure this job!</p>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>A mover has submitted a quote for your move</p>
          </div>
          <div class="content">
            ...
            <div class="mover-info">
              <h3 style="margin-top: 0; color: #7c3aed;">Mover Information</h3>
              <div class="detail-row">
            ...
            <p><strong>Don't wait too long!</strong> Good movers book up quickly, especially during peak moving season.</p>
            
            <a href="${process.env.FRONTEND_URL_MAIL}/bookings/${quoteData.bookingId}" class="button">View & Compare Quotes</a>
            
            <p>Compare this quote with others and choose the best fit for your move!</p>
  ...
  jobClaimed: (jobData) => ({
    subject: 'Congratulations! Meet your mover!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Your move has been claimed by a professional mover</p>
          </div>
          <div class="content">
            <h2>Hi ${jobData.customerName}!</h2>
            <p>Excellent news! A professional mover has claimed your job and is ready to help with your move.</p>
            
          
            
            <div class="mover-details">
              <h3 style="margin-top: 0; color: #059669;">Your Assigned Mover</h3>
              <div class="detail-row">
            ...
            <div class="message-box">
              <h4 style="margin-top: 0; color: #374151;">Message from Your Mover:</h4>
            ...
            <div class="contact-info">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                <li><strong>Your mover will contact you within 24 hours</strong> to confirm details and schedule</li>
                <li>Discuss any special requirements or questions about your move</li>
                <li>Confirm the final schedule and any additional services needed</li>
                <li>Your mover will arrive on the scheduled date ready to work</li>
              </ul>
            </div>
            
            <p><strong>Payment Security:</strong> Your deposit is secure with ALLinorout Moving. The remaining payment will be made directly to your mover upon completion of the job.</p>
            
            <a href="${process.env.FRONTEND_URL_MAIL}/bookings/${jobData.bookingId}" class="button">View Booking Details</a>
            
            <p>We're excited to help make your move smooth and stress-free!</p>
  ...
  bookingCompleted: (completionData) => ({
    subject: 'Move Completed Successfully - Thank You for Choosing ALLinorout Moving!',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Thank you for choosing ALLinorout Moving for your move</p>
          </div>
          <div class="content">
            <h2>Hi ${completionData.customerName}!</h2>
            <p>We're delighted to inform you that your move has been completed successfully. Thank you for trusting ALLinorout Moving with your moving needs.</p>
            ...
            <div class="completion-details">
              ...
              <div class="detail-row">
                <span class="detail-label">Move Date:</span>
                <span class="detail-value">${completionData.moveDate}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">From:</span>
            ...
            <div class="thank-you-box">
              <h3 style="margin-top: 0; color: #1d4ed8;">Thank You for Choosing ALLinorout Moving</h3>
              <p>We hope your moving experience was smooth and stress-free. Your mover has confirmed that all items have been safely delivered and the move is complete.</p>
              <ul style="margin: 10px 0; padding-left: 20px;">
                <li>All belongings have been safely transported</li>
                <li>Move completed to your satisfaction</li>
                <li>Final payment settled with your mover</li>
            ...
            <div style="background: #f0f9ff; border-left: 4px solid #0ea5e9; padding: 20px; margin: 25px 0; border-radius: 0 8px 8px 0;">
              <h3 style="margin-top: 0; color: #0c4a6e;">ALLinorout Moving – Quick Feedback</h3>
              ...
              <div style="margin: 15px 0;">
                <p style="margin: 10px 0 5px; font-weight: 600; color: #374151;">1. How would you describe your overall experience with ALLinorout Moving?</p>
                <p style="margin: 0; color: #6b7280;">⭐⭐⭐⭐⭐</p>
              </div>
              
              <div style="margin: 15px 0;">
                <p style="margin: 10px 0 5px; font-weight: 600; color: #374151;">2. How professional and friendly were your movers?</p>
                <p style="margin: 0; color: #6b7280;">⭐⭐⭐⭐⭐</p>
              </div>
              
              <div style="margin: 15px 0;">
                <p style="margin: 10px 0 5px; font-weight: 600; color: #374151;">3. How careful were the movers with your belongings?</p>
                <p style="margin: 0; color: #6b7280;">⭐⭐⭐⭐⭐</p>
              </div>
              
              <div style="margin: 15px 0;">
                <p style="margin: 10px 0 5px; font-weight: 600; color: #374151;">4. How easy was it to book and complete your move with us?</p>
                <p style="margin: 0; color: #6b7280;">⭐⭐⭐⭐⭐</p>
              </div>
              
              <div style="margin: 15px 0;">
                <p style="margin: 10px 0 5px; font-weight: 600; color: #374151;">5. Would you recommend ALLinorout Moving to others?</p>
            ...
            <p>Thank you once again for choosing ALLinorout Moving. We look forward to serving you in the future!</p>
  ...
  // Booking completion email (Mover)
  bookingCompletedMover: (completionData) => ({
    subject: 'Congratulations! Move Completed Successfully',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Another successful job through ALLinorout Moving</p>
          </div>
          <div class="content">
            <h2>Hi ${completionData.moverName}!</h2>
            <p>Congratulations on successfully completing another move through ALLinorout Moving! Your professional service continues to make our platform a trusted choice for customers.</p>
            ...
            <div class="congratulations-box">
              ...
              <p>Thank you for providing exceptional moving services. Your professionalism and attention to detail help maintain ALLinorout Moving's reputation for quality service.</p>
              <ul style="margin: 10px 0; padding-left: 20px;">
            ...
            <p>Thank you for being a valued partner with ALLinorout Moving. We look forward to connecting you with more customers!</p>
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="warning-box">
              ...
              <div class="detail-row">
                <span class="detail-label">Move Date:</span>
                <span class="detail-value">${new Date(cancellationData.moveDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">From:</span>
            ...
            <p><strong>Important:</strong> To secure your move, you must complete the deposit payment within 10 minutes of creating your booking. This ensures your moving slot is reserved and movers are notified.</p>
  ...
  longDistanceBookingConfirmation: (data) => ({
    subject: 'Long-Distance Move Request Received - ALLinorout Moving',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Long-Distance Move Request Received</title>
        <style>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1 style="margin: 0; font-size: 28px;">Long-Distance Move Request Received</h1>
            <p style="margin: 10px 0 0 0; font-size: 16px; opacity: 0.9;">Thank you for choosing ALLinorout Moving for your long-distance move!</p>
          </div>
          
          <div class="content">
            <p>Dear ${data.customerName},</p>
            
            <p>We've received your long-distance move request and our specialized team is already working on finding the perfect moving solution for you.</p>
            ...
            <div class="booking-details">
              ...
              <div class="detail-row">
                <span class="detail-label">Move Date:</span>
                <span class="detail-value">${new Date(data.moveDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">From:</span>
            ...
            <div class="next-steps">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                ...
                <li><strong>Personalized service:</strong> We'll work with specialized long-distance movers</li>
                <li><strong>No upfront payment:</strong> Payment is only required after you approve the quote</li>
                <li><strong>Full support:</strong> Our team will coordinate every aspect of your move</li>
              </ul>
            </div>
            ...
            <p>Best regards,<br><strong>The ALLinorout Moving Long-Distance Team</strong></p>
          </div>
          <div class="footer">
            <p><strong>support@allinoroutmoving.com</strong></p>
            <p>© ${new Date().getFullYear()} ALLinorout Moving. All rights reserved.</p>
  ...
  longDistanceBookingNotification: (data) => ({
    subject: `New Long-Distance Move Request - ${data.bookingId}`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>New Long-Distance Move Request</title>
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f8fafc; }
          .container { max-width: 600px; margin: 0 auto; background-color: #ffffff; }
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1 style="margin: 0; font-size: 28px;">New Long-Distance Move Request</h1>
            <p style="margin: 10px 0 0 0; font-size: 16px; opacity: 0.9;">Action Required - Customer Contact Within 24 Hours</p>
          </div>
          
          <div class="content">
            <div class="urgent">
              <h3 style="margin-top: 0; color: #dc2626;">URGENT: Long-Distance Move Request</h3>
            ...
            <p><strong>Note:</strong> This is a long-distance move request that requires specialized handling and coordination with our long-distance moving partners.</p>
          </div>
          <div class="footer">
            <p><strong>support@allinoroutmoving.com</strong></p>
            <p>© ${new Date().getFullYear()} ALLinorout Moving. All rights reserved.</p>
...
export const sendEmail = async (to, template, data = {}) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM || 'support@allinoroutmoving.com',
      to: to,
...
export const sendWelcomeMoverEmail = async (moverData) => {
  return await sendEmail(moverData.email, emailTemplates.welcomeMover, moverData);
};
...
export const sendBookingCompletedMoverEmail = async (completionData) => {
  return await sendEmail(completionData.moverEmail, emailTemplates.bookingCompletedMover, completionData);
};
